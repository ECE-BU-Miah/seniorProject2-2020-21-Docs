...
\todo[inline]{Jason can you write something up on this? not sure exactly what you did there or if you just want me to say the bear bones about it based on the video? also I know Miah put it down hear but should it be in chapter 4 since its more a test of the pure algorithm than of the actual robot? -Darrah}
\todo[inline]{In this section, we detail the steps of simulating the proposed
  robotic cart using a commercial robot simulator CoppeliaSim. $\ldots \ldots$ -Dr. Miah}
