...
%\documentclass{beamer}
  ...
  \end{block}
      ...
      \begin{minipage}[t]{0.5\textwidth}
        ...
        \caption{Medical Mobile Robotic Cart\footnote{\cite{kerr_2015}}}
        \label{fig:medCart}
      \end{minipage}
      \begin{minipage}[t]{0.4\textwidth}
        \centering
        \includegraphics[height=2.0cm]{figs/img/FactoryRoboticCart}
        \caption{Factory Mobile Robotic Cart \footnote{A footnote}}
        \label{fig:factCart}
      \end{minipage}
      \end{figure}
    %\footnotetext{\cite{kerr_2015}}
    %\footnote{\ref{kerr_2015}}
\end{frame}
...
\begin{frame}{Localization Algorithm}
  \begin{figure}
    \centering
    \begingroup
    \tiny
    \input{figs/dia/localizationAlgoFlowchartScaledDown.tex}
    \endgroup
...
\begin{frame}{Navigation Algorithm}
  \begin{figure}
    ...
    \begingroup
    \tiny
    \input{figs/dia/navigationAlgoFlowchartScaledDown.tex}
    \endgroup
