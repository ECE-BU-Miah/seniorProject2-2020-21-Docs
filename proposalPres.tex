  ...
  % applications of mobile robot navigation and problem description
    \begin{itemize}
        ...
        %\item Existing Solutions
         %   \begin{itemize}
          %      \item Follow user carrying a remote device
           %     \item Require line-of-sight communication
           % \end{itemize}
        %\item Proposed Improvement
         %   \begin{itemize}
          %    \item Use wireless signal strength
           %   \item Does not require line-of-sight communication
            %\end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}{System Architecture}
    \begin{block}{Quad-Parabolic Reflector}
    Draft design of a quad-parabolic reflector created by Jason Braker
    \end{block}
    \begin{figure}[b]
        \centering
...
\begin{frame}{System Architecture}
    \begin{block}{Quad-Parabolic Reflector}
    Our group's draft design of a quad-parabolic reflector created by Jason Braker
    \end{block}
    \begin{figure}[b]
        \centering
        \includegraphics[width=0.50\textwidth]{figs/img/parabolicReflector}
        \caption{Proposed Changes to the Quad-Parabolic Reflector}
...
\begin{frame}{System Architecture}
    \begin{block}{Updated CoppeliaSim Model of Mobile Robot}
    Finalized version of the CoppeliaSim Budget Bot model created by Jason Braker
    \end{block}
    \begin{figure}[b]
        \centering
        \includegraphics[width=0.75\textwidth]{figs/img/budgetBotModel}
        \caption{Finalized Budget Bot Chassis in CoppeliaSim}
        \label{fig:coppeliasimModel}
    \end{figure}
\end{frame}
...
\begin{frame}{System Architecture}
    \begin{block}{CoppeliaSim Model Demonstration of Mobile Robot}
    CoppeliaSim demonstration of the Budget Bot model implementing a modified point navigation Matlab code
    \end{block}
    %\begin{figure}[b]
    %    \centering
    %    \includegraphics[width=0.75\textwidth]{figs/img/budgetBotModel}
