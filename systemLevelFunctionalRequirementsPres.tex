...
\title[Robotic Cart System]{Robotic Cart System}
...
\date[October~13,~2020]{Tuesday, October~13,~2020}
...
\begin{frame}{Introduction}{}
  % applications of mobile robot navigation and problem description
    \begin{itemize}
        \item Purpose of Robotic Carts
            \begin{itemize}
                \item Carry groceries at a store
                \item Carry files in an office
                \item Carry objects in the home
                \item Useful for people with disabilities
            \end{itemize}
